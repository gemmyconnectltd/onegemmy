...
from app.modules.accounting.routes import accounting_router
...
api_router.include_router(accounting_router, prefix="/tenants", dependencies=[Depends(require_feature("accounting"))])
