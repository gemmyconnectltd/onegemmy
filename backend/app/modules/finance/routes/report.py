...
router = APIRouter(tags=["Finance - Reports"])
...
@router.get("/finance/reports/income-statement")
...
@router.get("/finance/reports/balance-sheet")
...
@router.get("/finance/reports/{statement}/export")
async def export_finance_report(
    ...
    filename, content, media_type = await service.export_finance_statement(
