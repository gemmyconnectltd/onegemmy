...
@router.post("/finance/tax/calculate/paye")
...
@router.post("/finance/tax/calculate/vat")
...
@router.post("/finance/tax/calculate/withholding")
...
@router.post("/finance/tax/calculate/pension")
...
@router.post("/finance/tax/calculate/corporate")
...
@router.post("/finance/tax/calculate/consumption")
...
@router.get("/finance/tax/configs")
...
@router.post("/finance/tax/configs")
...
@router.patch("/finance/tax/configs/{config_id}")
...
@router.get("/finance/tax/calculations")
...
@router.post("/finance/tax/calculations")
...
@router.get("/finance/tax/summary/{period}")
...
@router.get("/finance/tax/payments")
...
@router.post("/finance/tax/payments")
