...
@router.patch("/accounting/expenses/{id}")
...
@router.post("/accounting/expenses/{id}/approve")
...
@router.post("/accounting/expenses/{id}/reject")
...
@router.delete("/accounting/expenses/{id}")
