...
from app.modules.inventory.schemas.product import ProductCreate, ProductBulkCreate, ProductBulkResult, ProductRead, ProductUpdate, RestockRequest, VariantCreate, VariantRead, VariantUpdate, VariantListRead
...
__all__ = [
    ...
    "VariantCreate", "VariantRead", "VariantUpdate", "VariantListRead",
