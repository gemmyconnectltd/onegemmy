# OneGemmy — Project Rules (Readable Reference)

Source of truth: the root `AGENTS.md`. This is the same content, formatted for reading/review. Keep this doc and `AGENTS.md` in sync when rules change.

## Project overview

Multi-tenant ERP (SaaS) for small/medium businesses. Monorepo:
