...
export function HeldSalesDrawer({ orders, currencySymbol, fmt, onResume, onDelete }: HeldSalesDrawerProps) {
  return (
    <div className="border-t border-border bg-card px-4 py-3">
      <div className="flex items-center gap-1.5 mb-2.5 text-[11px] font-semibold text-muted-foreground uppercase tracking-wide">
            ...
            return (
              <div key={h.id} className="flex items-center gap-3 px-3 py-2.5 border border-border rounded-xl">
                ...
                <button
                  ...
                  className="flex items-center gap-1 px-2.5 py-1.5 bg-primary text-primary-foreground text-[12px] font-semibold rounded-lg hover:opacity-90 transition"
                >
