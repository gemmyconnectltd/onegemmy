    ...
    <div className="min-h-full flex flex-col pb-6">
      ...
      <div className="flex-1 px-4 pt-4 space-y-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link href="/m/restock" className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-accent text-white text-[11px] font-semibold">
        ...
        <div className="space-y-2">
          ...
          {filtered.length === 0 && (
            <div className="py-12 text-center">
              ...
              <Link href="/m/products/new" className="mt-3 inline-block px-4 py-2.5 rounded-xl bg-accent text-white text-[12px] font-semibold">
                Add a product
              </Link>
            </div>
          )}
