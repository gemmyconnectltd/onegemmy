  ...
  if (doneRef) {
    return (
      <div className="min-h-full flex flex-col items-center justify-center px-8 text-center">
        ...
        <Link href="/m/transactions" className="mt-6 w-full py-3 rounded-2xl bg-accent text-white text-[13px] font-semibold">
          View transactions
        </Link>
        <Link href="/m/inventory" className="mt-2 w-full py-3 rounded-2xl border border-border text-[13px] font-semibold text-foreground">
          Check inventory
        </Link>
      </div>
    );
