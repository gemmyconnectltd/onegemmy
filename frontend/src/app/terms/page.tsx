...
export const metadata: Metadata = {
  title: "Terms of Service - OneGemmy",
};
  ...
  return (
    <LegalLayout title="Terms of Service" lastUpdated="September 10, 2026">
      <p>
        ...
        use of OneGemmy, provided by {siteConfig.company} (&quot;we&quot;,
        &quot;us&quot;). By creating an account or using OneGemmy, you agree
      ...
      <h2>2. Your data</h2>
      <p>
        You retain ownership of all business data you enter into OneGemmy —
      ...
      <p>
        OneGemmy offers a free plan and paid plans with additional users,
      ...
      <ul>
        <li>Use OneGemmy for any unlawful purpose, or to store data you don&apos;t have the right to store.</li>
        ...
        <li>Resell or provide access to OneGemmy to third parties outside your own business without our agreement.</li>
      </ul>

      <h2>5. Availability</h2>
      <p>
        We work to keep OneGemmy available and reliable, but the service is
      ...
      <p>
        You may stop using OneGemmy and close your account at any time. We
      ...
      <p>
        ...
        from your use of OneGemmy. Nothing in these Terms limits liability
