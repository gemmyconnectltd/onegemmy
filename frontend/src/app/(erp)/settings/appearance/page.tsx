...
import { businessThemes, type BusinessType } from "@/lib/config";
import { Check } from "lucide-react";

export default function AppearancePage() {
  const { businessType, setBusinessType, businessTypes, locale, setLocale, locales, currency, setCurrency, currencies } = useAppConfig();
