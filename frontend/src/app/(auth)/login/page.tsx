                ...
                {([
                  ...
                  },
                  {
                    ...
                    users: [
                      ...
                      { label: "Purchases",    email: "procurement.manager@onegemmy.com", password: "user123",  desc: "Purchases" },
                      { label: "Purch. Staff", email: "procurement.staff@onegemmy.com",   password: "user123",  desc: "Purch. staff" },
                    ],
                  },
                  {
                    ...
                    users: [
                      ...
                      { label: "Purchases",    email: "procurement.manager@freshmart.rw", password: "user123",  desc: "Purchases" },
