...
const SECTIONS = [
  { href: "/account/profile", label: "Business profile", desc: "Name, phone, address", icon: Building2 },
  { href: "/account/payments", label: "Payment methods", desc: "Cash, mobile, card", icon: CreditCard },
  { href: "/account/taxes", label: "Taxes", desc: "VAT & receipts", icon: ReceiptText },
  { href: "/account/printer", label: "Printer settings", desc: "Paper size, copies", icon: Printer },
  { href: "/account/notifications", label: "Notifications", desc: "Alerts & summaries", icon: Bell },
  { href: "/account/support", label: "Help & support", desc: "FAQ, contact & help", icon: LifeBuoy },
];
