...
export default function MobileHomePage() {
  ...
  const tiles = [
    ...
    { href: "/inventory",    label: "Inventory",  icon: Boxes,          color: "#10b981" },
    { href: "/products/new", label: "Products",   icon: PackagePlus,    color: "#8b5cf6" },
    { href: "/customers",    label: "Customers",  icon: Users,          color: "#0ea5e9" },
    { href: "/suppliers",    label: "Suppliers",  icon: Truck,          color: "#f59e0b" },
    { href: "/expenses",     label: "Expenses",   icon: Wallet,         color: "#dc2626" },
  ];
