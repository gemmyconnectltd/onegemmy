        ...
        <div className="px-5 pt-5 pb-3 border-b border-border">
          <div className="flex items-center gap-2">
            {tenant.logo_url ? (
              ...
              <div
                className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 text-white font-extrabold text-[13px]"
                style={{ backgroundColor: tenant.brand_color ?? "var(--primary)" }}
              >
